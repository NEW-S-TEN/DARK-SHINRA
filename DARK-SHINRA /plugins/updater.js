    ...
    if (cmd === "update") {
        ...
        try {
            ...
            const { data: commitData } = await axios.get(
                "https://github.com/NEW-S-TEN/DARK-SHINRA/commits/main"
            );
            ...
            const response = await axios({
                method: 'get',
                url: "https://github.com/NEW-S-TEN/DARK-SHINRA/archive/main.zip",
                responseType: 'stream'
            });
            ...
            const sourcePath = path.join(extractPath, "𝐃𝐀𝐑𝐊-𝐒𝐇𝐈𝐍𝐑𝐀-main");
